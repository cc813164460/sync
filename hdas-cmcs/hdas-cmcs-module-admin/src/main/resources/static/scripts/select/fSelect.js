    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                this.$select.before('<div class="fs-label-wrap"><div class="fs-label select-label">' + this.settings.placeholder + '</div><span class="fs-arrow"></span></div>');
            ...
            reloadDropdownLabel: function() {
                ...
                this.$wrap.find('.fs-label').html('<span style="line-height: 2em">' + labelText + '</span>');
                this.$select.change();
            }
        }
